...
/**
 * This is the Test Case for get_cost method with 2 parameters Hours and Price
 * 
 * @author Aacshwin Ravichandran
 * @version 1.0
 * @since 2020-12-23
 */
public class HoursAndPriceTest {

	@Test
	public void test() {
		CpuInstanceAllocator cia = new CpuInstanceAllocator();
		List<ResultModel> rmList = cia.get_cost(8, 180F);
		...
		rmAsia.setTotal_cost(179.35999F);
		Map<String, Integer> servers = rmAsia.getServers();
		servers.put("8xlarge", 19);
